(function (factory) {
    ...
    ***************************************************************************** */
    ...
    var isModuleReady = function (module) {
        if (module.cost.kind === "TOTAL") {
            return module.cost.assigned >= module.cost.amount;
        }
        else {
            return module.cost.values.every(function (v, ix) { return !!module.cost.assigned[ix]; });
        }
    };
    var getEffect = function (module) {
        var attr = module.damage ? "DMG" : "HP";
        var x = module.damage || module.repair;
        var amount = x.kind === "SUM" ? "*" : x.amount;
                ...
                a$1("button", {
                    ...
                    onclick: function () {
                        if (isModuleReady(module)) {
                            dispatch({ type: "USE_WEAPON", index: index });
                        }
                    }
                }, "Use"),
            ]),
    ...
    var View = function () {
        var _a = useState(), myShip = _a.ship, inBattle = _a.inBattle, myTurn = _a.myTurn;
        if (!myShip) {
            return a$1(y, null, [
            ...
            return a$1(y, null, [
                ...
                a$1("div", { "class": "row" }, [
                    ...
                    inBattle
                        ? myTurn
                            ? a$1(DiceSection, null)
                            : a$1(EnemyDiceSection, null)
                        : null,
                ]),
            ]);
        }
    ...
    var Footer = function () {
        return a$1("center", null, a$1("footer", null, [
            "Captain on the Bridge ",
            a$1("strong", null, "•"),
            " ",
            a$1("a", { href: "https://github.com/tkers/captain-on-the-bridge" }, "Source"),
        ]));
    };
    var Game = function () {
        var _a = useState(), inBattle = _a.inBattle, myTurn = _a.myTurn;
        return a$1(y, null, [
