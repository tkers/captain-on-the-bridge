(function (factory) {
    ...
    const ShipSelectCard = ({ ship, onSelect }) => {
      return a$1("div", { class: "card" }, [
        ...
        a$1("button", { class: "snd", onclick: () => onSelect(ship) }, "Launch!"),
      ]);
    };
    ...
    const Game = () => {
      const [myShip, selectShip] = l(null);
      if (!myShip) {
        return [
          a$1("h2", null, "Choose your starship:"),
          a$1("center", null, [
            a$1(ShipSelectCard, { ship: fighter, onSelect: selectShip }),
            a$1(ShipSelectCard, { ship: intercepter, onSelect: selectShip }),
            a$1(ShipSelectCard, { ship: cruiser, onSelect: selectShip }),
          ]),
        ];
      } else {
        return [
